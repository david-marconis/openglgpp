...
int main()
{
    ...
    Model xwing = Model("resources/xwing/");
    xwing.loadModel("x-wing.obj");

    Model starDestroyer = Model("resources/stardestroyer/");
    starDestroyer.loadModel("Test.obj");
    ...
    while (!windowManager.shouldClose())
    {
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-2.5f, 0.0f, 10.0f));
        model = glm::scale(model, glm::vec3(0.00001f, 0.00001f, 0.00001));
        glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
        shinyMaterial.useMaterial(uniformSpecularIntensity, uniformShininess);
